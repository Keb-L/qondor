...
class SHFile(object):
    ...
    def set_cms_env_and_pip(self):
        lines = [
            ...
            'xrdcp root://cmseos.fnal.gov//store/user/pedrok/sonic/store_mc_RunIISpring18MiniAOD_BulkGravTohhTohbbhbb_narrow_M-2000_13TeV-madgraph_MINIAODSIM_100X_upgrade2018_realistic_v10-v1_30000_24A0230C-B530-E811-ADE3-14187741120B.root data.root'    
        ]
        return lines
